                ...
                <div class="x_panel">
                  ...
                  {!! Form::open(array('route' => 'persons.store','method'=>'POST')) !!}
                      ...
                      <div class="col-md-8 col-sm-8 col-xs-12 form-group has-feedback">
                        ...
                        <span class="fa fa-phone form-control" aria-hidden="true"></span>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                  ...
                                  <div class="radio">
                                    <label>
                                      <input type="radio" checked="checked" value="f" id="optionsRadios1" name="gender">Female
                                    </label>
       
                                    <label>
                                      <input type="radio" value="m" id="optionsRadios2" name="gender"> Male
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        ...
                        {!! Form::textarea('observ', null, array('placeholder' => 'comments','class' => 'form-control','style'=>'height:100px')) !!}
                      </div>
